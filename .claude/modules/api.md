...
GET    /api/aftersale/cases/export                    # 导出全量工单 xlsx（需 aftersale:export 权限）
                                                      #   params 与 /cases 相同（无分页）；一行一条原因记录
                                                      #   列：订单号/售后日期/购买日期/间隔天数/产品型号/产品名称/
                                                      #       一级原因/二级原因/发货物料简称/渠道/省份/城市/县区/
                                                      #       商家备注/买家留言
