...
import { WORLD_NAME_ZH, ZH_TO_GEOJSON_NAME } from '@/utils/worldCountries'
...
// 国家中文名 → 世界地图 GeoJSON 英文名（含 217 个区划规范名 + 常见别名，见 utils/worldCountries.js）。
// 台湾/香港/澳门不在这里映射：ensureWorldMap 已经把它们从中国省级地图里抠出来，
// 以"台湾"/"香港"/"澳门"这三个中文名直接注册成独立区划，标签值本身就能匹配上，无需转换
const COUNTRY_NAME_MAP = ZH_TO_GEOJSON_NAME
