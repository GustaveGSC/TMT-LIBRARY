"""
数据库变更脚本：售后工单表扩展 v2
  1. aftersale_case 加 city（城市）
  2. aftersale_case 加 purchase_date（用户填写的购买日期）

在 backend/ 目录下执行：python alter_tables_aftersale_case_v2.py
"""
import sys
import os
...
NEW_COLUMNS = [
    ("aftersale_case", "city",          "VARCHAR(100) NULL"),
    ("aftersale_case", "purchase_date", "DATE NULL"),
]
